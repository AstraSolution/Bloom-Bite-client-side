...
const Register = () => {
  ...
  const handleRegister = async () => {
    if (!/^(?=.*[A-Z])(?=.*[\W_]).{6,}$/.test(password)) {
      setError(
        "Error: Password must be at least 6 characters in length, must contain a capital letter and a special character"
      );
    } else {
      setError("");
      if (email) {
                ...
                <div className="block rounded-lg bg-[#1d1b1d] shadow-lg dark:bg-neutral-800">
                  <div className="g-0 lg:flex lg:flex-wrap">
                    <div
                      ...
                      style={{
                        background:
                          'linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("https://i.ibb.co/rHck9hp/test1000px.png")',
                    ...
                    <div className="px-4 md:px-0 lg:w-6/12">
                      <div className="md:mx-6 md:p-12">
                        <div className="text-center">
                          <img className="mx-auto h-40" src={Logo} alt="logo" />
                        ...
                        <form>
                          ...
                          <div className="flex items-center justify-between pb-6">
                            <Link to={`/login`}>
                              <p className="mb-0 mr-2 text-neutral-100">
                                Have an account?
                              </p>
                            </Link>
                            <Link to={`/login`}>
