                        ...
                        <div className="h-full">
                            <div className="g-6 flex h-full flex-wrap items-center justify-center text-neutral-800 dark:text-neutral-200">
                                <div className="w-full">
                                    <div className="block rounded-lg bg-[#1d1b1d] shadow-lg dark:bg-neutral-800">
                                        <div className="g-0 lg:flex lg:flex-wrap">
                                            ...
                                            <div className="px-4 md:px-0 lg:w-6/12">
                                                <div className="md:mx-6 md:p-12">
                                                    ...
                                                    <form>
                                                        <p className="mb-4 text-neutral-100">Please register an account</p>
                                                        ...
                                                        <div className="mb-12 pb-1 pt-1 text-center">
                                                            ...
                                                            <div className='flex justify-between items-center'>
                                                                <a href="#!" className='text-neutral-100'>Terms and conditions</a>
                                                                <button
                                                                    type='button'
                                                        ...
                                                        <div className='flex items-center gap-2 text-white mb-6'>
                                                            <h1 className='flex items-center gap-1'>I Have read Agreed to the <span className="text-purple-600 underline cursor-pointer" onClick={() => document.getElementById('my_modal_1').showModal()}>Terms</span> and <span className="text-purple-600 underline cursor-pointer" onClick={() => document.getElementById('my_modal_1').showModal()}>Conditions</span></h1>
                                                            <input type="checkbox" defaultChecked className="checkbox" />
                                                        </div>
                                                        <div className="flex items-center justify-between pb-6">
                                                            <Link to={`/login`}>
                                                                <p className="mb-0 mr-2 text-neutral-100">Have an account?</p>
                                                            </Link>
                                                            <Link to={`/login`}>
                                                                <button
                                                                    type="button"
                                                                    className=" inline-block border-2 border-danger px-6 pb-[6px] pt-2 text-xs font-medium uppercase leading-normal text-danger transition duration-150 ease-in-out hover:border-danger-600 hover:bg-neutral-500 hover:bg-opacity-10 hover:text-danger-600 focus:border-danger-600 focus:text-danger-600 focus:outline-none focus:ring-0 active:border-danger-700 active:text-danger-700 dark:hover:bg-neutral-100 dark:hover:bg-opacity-10"
                                                                    data-te-ripple-init
                                                                    data-te-ripple-color="light">
                                                                    Login
                                                                </button>
            ...
            <dialog id="my_modal_1" className="modal">
                <div className="modal-box">
                    <div className='space-y-4'>
                        <h1 className='text-xl md:text-2xl font-bold'>Bloom Bite Website Terms and Conditions</h1>
                        <div className='space-y-2 '>
                            <h2 className='md:text-lg font-bold'>1. Acceptance of Terms</h2>
                            <p className='text-sm md:text-base font-medium'>By accessing and using the [Your Restaurant Name] website, you agree to comply with and be bound by the following terms and conditions. If you do not agree with these terms, please refrain from using our website.</p>
                        </div>
                        <div className='space-y-2 '>
                            <h2 className='md:text-lg font-bold'>1. Acceptance of Terms</h2>
                            <p className='text-sm md:text-base font-medium'>By accessing and using the [Your Restaurant Name] website, you agree to comply with and be bound by the following terms and conditions. If you do not agree with these terms, please refrain from using our website.</p>
