...
const Cards = () => {
  return (
    <section className=" justify-center items-center gap-x-16 text-white menu-card">
      <div className="w-[350px] h-[450px] bg-transparent cursor-pointer group perspective">
        <div className="relative preserve-3d border-2 border-red-600 group-hover:my-rotate-y-180 focus:my-rotate-y-180 w-full h-full duration-[1500ms]">
